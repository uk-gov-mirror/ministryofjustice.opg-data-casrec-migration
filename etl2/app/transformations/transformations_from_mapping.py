...
def do_simple_mapping(simple_mapping, table_definition, source_data_df):
...
def do_simple_transformations(transformations, source_data_df):
...
def add_required_columns(required_columns, source_data_df):
